...
export class GitEngineService {
  ...
  async mirror(
    ...
    // Pass tokens securely via credential.helper in config, avoiding URLs with embedded secrets
    ...
    await this.push(repoDir, targetUrl, source.name, targetToken, onProgress);
  }
