...
export class GitEngineService {
  ...
  private bitbucketToken: string;
  private githubToken: string;

  constructor(tempDir: string, bitbucketToken: string, githubToken: string) {
  ...
  async mirror(
    ...
    }).env({ ...GIT_ENV, BITBUCKET_TOKEN: this.bitbucketToken });
  ...
  private async push(
    ...
    }).env({ ...GIT_ENV, GITHUB_TOKEN: this.githubToken });
